...
private fun makePopupMenu(): JPopupMenu {
  ...
  popup.add("Å´ add(new JSeparator()")
  popup.add(JSeparator())
  popup.add("Å´ JSeparator(): height = 8")
  ...
  popup.add("Å´ addSeparator()")
  popup.addSeparator()
  popup.add("Å´ JPopupMenu.Separator(): height = 4")
  ...
  popup.add("Å´ JPopupMenu.Separator(): font size 16f")
  popup.add(object : JPopupMenu.Separator() {
    override fun getFont() = super.getFont().deriveFont(16f)
  })
  popup.add("Å´ PopupMenuSeparator.contentMargins")
  popup.add(object : JPopupMenu.Separator() {
