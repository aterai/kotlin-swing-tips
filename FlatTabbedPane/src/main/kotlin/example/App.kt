...
class MainPanel : JPanel(BorderLayout()) {
  ...
  init {
    ...
    tabs.addTab("A", ImageIcon(javaClass.getResource("wi0009-32.png")), JScrollPane(JTree()))
    tabs.addTab("B", ImageIcon(javaClass.getResource("wi0054-32.png")), JScrollPane(JTextArea()))
    tabs.addTab("C", ImageIcon(javaClass.getResource("wi0062-32.png")), JScrollPane(JTree()))
    tabs.addTab("D", ImageIcon(javaClass.getResource("wi0063-32.png")), JScrollPane(JTextArea()))
