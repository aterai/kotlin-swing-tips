...
private class RubberBandSelectionList(model: ListModel<ListItem>) : JList<ListItem>(model) {
  ...
  private fun <E> getItemCheckBox(list: JList<E>, pt: Point, index: Int): AbstractButton? {
